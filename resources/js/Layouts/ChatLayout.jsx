    ...
    const messageCreated = (message) => {
        setLocalConversations((oldConversations) => {
            ...
            return oldConversations.map((oldConversation) => {
                ...
                if(message.receiver_id && oldConversation.is_user && (oldConversation.id == message.sender_id || oldConversation.id == message.receiver_id)){

                    oldConversation.last_message = message.message;
                    oldConversation.last_message_date = message.created_at;
                    return oldConversation;

                } else if(message.group_id && oldConversation.is_group && oldConversation.id == message.group_id){

  ...
  return (
    <>
        {attachments.length > 0 && (
            <div className='mt-2 inline-flex flex-wrap w-fit  items-center gap-1'>
            {/* // <div className="grid grid-cols-auto gap-2 w-fit"> */}
                    ...
                    >
                        {!isAudio(attachment) && (
                            <a 
                                ...
                                download
                                href={attachment.url}
                                className='z-20 opacity-100 group-hover:opacity-100 transition-all w-8 h-8 flex items-center justify-center text-gray-100 bg-gray-700 rounded absolute top-0 right-0 cursor-pointer hover:bg-gray-800'
                            >

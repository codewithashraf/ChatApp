                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="h-screen w-screen">
                        <Transition.Child
                            as={Fragment}
                            enter="ease-out duration-300"
                            enterFrom="opacity-0 translate-y-4 sm:traslate-y-0 sm:scale-95"
                            enterTo="opacity-100 translate-y-0 sm:scale-100"
                            leave="ease-in duration-200"
                            leaveFrom="opacity-100 translate-y-0 sm:scale-100"
                            leaveTo="opacity-0 translate-y-4 sm:traslate-y-0 sm:scale-95"
                        >
                            <Dialog.Panel className="w-full h-full flex flex-col transform overflow-hidden bg-slate-800 text-left align-middle shadow-xl transition-all">
                                <button
                                    onClick={close}
                                ...
                                <div className="relative group h-full">
                                    {currentIndex > 0 && (
                                        ...
                                        >
                                            <ChevronLeftIcon className="w-1/2" />
                                        </div>
                                    )}
                                    ...
                                    {currentIndex <
                                        ...
                                        >
                                            <ChevronRightIcon className="w-1/2" />
                                        </div>
                                    )}
                                    ...
                                    {attachment && (
                                        <div className="flex items-center justify-center w-full h-full p-3">
                                            ...
                                            {!isPreviewable(attachment) && (
                                                <div className="p-32 flex flex-col justify-center items-start text-gray-100">
